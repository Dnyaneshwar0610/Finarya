...
public class TC03_UpdateViewDepartment extends TestBase{
	...
	public void update(String DName,String ParentDep,String Product,String Process,String Risk,String Control) throws Exception{
		FinaryaTC03_UpdateViewDepartmentPage updatepage = new FinaryaTC03_UpdateViewDepartmentPage(driver);
		Thread.sleep(1000);
		updatepage.clickonlistdep();
	...
	public void Logout() {
		FinaryaTC03_UpdateViewDepartmentPage updatepage = new FinaryaTC03_UpdateViewDepartmentPage(driver);
		updatepage.clickonprofile();
		updatepage.clickonlogout();
		driver.close();
	}
}
