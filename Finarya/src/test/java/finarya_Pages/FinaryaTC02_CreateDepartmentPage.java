...
public class FinaryaTC02_CreateDepartmentPage {
	...
	public FinaryaTC02_CreateDepartmentPage(WebDriver driver) {
		this.driver = driver;
	...
	public void clickonCreateDepart() {
		CreateDepatment.click();
